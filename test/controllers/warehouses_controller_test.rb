...
class WarehousesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create warehouse" do
    assert_difference('Warehouse.count') do
      post warehouses_url, params: { warehouse: { barcode: @warehouse.barcode, product: @warehouse.product, quantity_per_box_or_carton: @warehouse.quantity_per_box_or_carton, total_cost: @warehouse.total_cost, units: @warehouse.units, user_id: @warehouse.user_id } }
    end
  ...
  test "should update warehouse" do
    patch warehouse_url(@warehouse), params: { warehouse: { barcode: @warehouse.barcode, product: @warehouse.product, quantity_per_box_or_carton: @warehouse.quantity_per_box_or_carton, total_cost: @warehouse.total_cost, units: @warehouse.units, user_id: @warehouse.user_id } }
